...
class Car {
    ...
    // 클래스의 행동(메서드):
        // 클래스 내부에서 정의된 함수, 객체의 행동을 표현 > 클래스의 속성(필드)을 사용하여 특정 작업을 수행하거나, 해당 값을 변경 또는 반환 가능
    ...
    /*
        ...
        void 반환 타입:
            해당 메서드(함수, 기능)의 반환하는 결과가 없을 때 사용
...
public class Object03 {
    public static void main(String[] args) {
        ...
        Car myCar = new Car("K5", 2016);

        // === 객체 사용 ===
        // .연산자를 사용하여 객체 내부의 필드와 메서드 사용
