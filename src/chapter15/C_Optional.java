...
/*
    Optional 클래스:
        - 값이 존재할 수도 있고 없을 수도 있는 객체를 감싸는 컨테이이너
...
//        System.out.println(optional3.get()); // NoSuchElementException 오류
        ...
        // - 모든 곳에 Optional을 사용할 필요는 없음
            // 반환 값에만 사용하는 것을 권장
            // - 필드 & 매개변수로 사용하면 안됨
        // - 값이 반드시 있어야 하는 경우 Optional을 사용하지 않음
