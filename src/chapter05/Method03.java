...
public class Method03 {
    public static void main(String[] args) {
        ...
        // System.out.println(myMath.divide(10, 0)); // 나누는 값이 0 => 자바에서는 정수형에서 0으로 나누기를 시도하면 Exception 발생
        // 실수형 연산에서는 오류가 발생하지 않는다.
        myMath.divide(10, 0);
