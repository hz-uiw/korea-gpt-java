...
/*
    java.lang 패키지:
        ...
        1. Object 클래스:
            - 자바에서 모든 크래스의 최상위 클래스 => 모든 클래스는 Object 클래스를 상속 받음
...
class MyClass extends Object {
    ...
    // 2) equals(Object obj) 메서드
        ...
        // - 오버라이딩(재정의): 객체 내용 기반의 비교를 구현

}
public class JavaLang {
    public static void main(String[] args) {
        System.out.println("============= Object 클래스 =============");
        MyClass myClass1 = new MyClass(1, "권민창");
        // System.out.println(myClass1.toString()); // chapter09.MyClass@49e4cb85
        System.out.println(myClass1.toString()); // MyClass(ID: 1/ NAME: 권민창)

        MyClass myClass2 = new MyClass(2, "권민");
        ...
        System.out.println(Math.random()); // 무작위 난수 생성 - .random == 0.0 이상 ~ 1.0 미만의 난수 생성
        ...
        // substring(int start, int end);
            // 시작 인덱스(포함)부터 끝 인덱스(미포함)까지의 부분 문자열 반환
