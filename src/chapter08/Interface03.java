...
/*
    인터페이스의 멤버 변수의 특성:
        - 자동으로 public static final (어디서든 접근 가능) 특성을 가진다
        >> 인스턴스화 없이 인터페이스명으로 접근 가능 (모두 같은 값 공유), 값 변경 불가능
...
class ExampleClass implements Example1, Example2 {
    ...
    // cf) 다중 인터페이스 주의사항:
        // 여러개의 인터페이스에서 같은 시그니처(선언부)를 가진 디폴트 메서드가 존재할 경우
        // >> 반드시 오버라이드하고 명시적으로 구현해야 함
    @Override
    public void method() {
...
public class Interface03 {
    public static void main(String[] args) {
        ...
        */
        ...
        // example1.printVar2(); - Error (Example1에 정의 되지 않음)
