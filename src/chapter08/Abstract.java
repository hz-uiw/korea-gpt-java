...
/*
    추상화(Abstract):
        ...
        2. 추상 클래스 특징:
            1) 클래스 자체로 인스턴스 생성이 안된다
            2) 하나 이상의 추상 메서드를 포함해야 한다
            3) 확장성 제공을 위해 사용 - 자식 클래스들이 공통된 기능을 공유와 고유 기능을 구현하도록 강제한다
            4) 다중 상속 불가능 - 하나의 extends만 가능하다
    ...
    void stripe() { - 해당 메서드를 상속 받을 수 없음
        ...
        3. 추상 클래스 구현 방법:
            ...
            +) 추상 메서드:
                ...
                >> abstract 키워드를 사용하면 구현부 {} 대신 세미콜론(;)을 사용하여 선언을 마침
...
class Police extends Human {
    // 추상 메서드를 구현
    void work() {
        System.out.println("경찰은 치한유지 업무를 담당합니다.");
    }
}
...
public class Abstract {
    public static void main(String[] args) {
        ...
        dog.makeSound(); // 멍멍
        dog.eat(); // 강아지는 개껌을 먹습니다. -> 오버라이드로 재정의
