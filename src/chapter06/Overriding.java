...
class ChildClass extends ParentClass {
    ...
    // cf) @Override를 생략해도 오류가 나지 않는 이유
        // : 자바 컴파일러가 메서드 시그니처(이름, 매개변수, 반환타입)를 비교하여 부모 클래스의 메서드를 자식 클래스에서 재정의했는지 판단
    void exercise () {
...
/*
    1. 오버라이딩 특징:
        - 메서드의 시그니처가 일치해야함 -> 부모 클래스에서 정의된 메서드와 동일한 이름, 매개변수 구성을 가져야 함
            반환 타입은 같거나 자동 형 변환이 가능하게 작성해야 함
    ...
    3. 오버라이딩 사용 목적:
        ...
        - 재사용성, 확장석 향상: 기존의 코드 변경 없이, 새로운 기능을 추가하거나 변경 가능
 */
...
public class Overriding {
    public static void main(String[] args) {
        ...
        /*
            ...
            1) 오버로딩:
                - "같은 클래스 내"에서 같은 이름을 가진 메서드를 여러 개 정의하는 것
                - 메서드명은 동일해야하고 매개변수의 타입, 개수, 순서 중 적어도 하나 이상은 달라야한다
                - 반환타입은 관련이 없다
            ...
            2) 오버라이딩:
                ...
                - 메서드의 동작을 변경하거나 확장시킨다
                - @Override 어노테이션 사용 => 컴파일러에게 전달하는 역할
         */
    }
}
