...
/*
    캡슐화(Encapsulation):
        ...
        - 객체 내부의 구현을 숨기고 외부에서는 제공된 메서드를 통해서만 접근할 수 있게 설정 -> 데이터 보호, 유지보수성 향상, 사용자 편의성 증대

        - 데이터 보호와 유지보수성 향상을 목적으로 데이터 필드(속성)를 private으로 선언 & 데이터에 접근하거나 수정할 때는 getter와 setter 메서드를 사용하게 하는 체계
