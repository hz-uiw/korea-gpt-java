...
/*
    접근 제한자(제어자):
        - 클래스, 메서드, 변수의 접근 범위를 제어하여 외부로부터 데이터를 보호하고 객체 간의 의존성을 최소화하는 역할
        - 캡슐화 구현, 코드의 보안성을 향상

        1. 접근 제한자 종류:
            - private, default, protected, public
            - 접근 제한자가 지정되지 않은 경우 기본값(default)으로 지정

        클래스 자체에 접근 제한자를 사용하지 않는다.
            - 중첩 클래스의 경우, 사용 가능
 */
// public class Modifier {} - Error (접근 제한자 사용 X)
/*
        2. 접근 제한자 범위:
...
//          2) (default): 같은 패키지 내라면 접근, 패키지 외부에는 접근 불가능
...
//          3) protected: 동일한 패키지 내의 모든 클래스 내에서 접근 가능, 다른 패키지에 있는 경우, 해당 클래스를 상속받은 하위 클래스에서만 접근 가능
...
//        System.out.println(super.otherField); // super 생략가능
...
//          4) public: 어떤 클래스든 어떤 패키지 내에 있든 접근 가능
...
public class A_Modifier {
    ...
    public static void main(String[] args) {
        ...
        // private 설정 된 속성와 메서드는 해당 클래스 내부에서만 읽을 수 있다
