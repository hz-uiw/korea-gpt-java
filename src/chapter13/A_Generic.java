...
/*
    제네릭(Generic, 일반적인):
        ...
        - 클래스나 메서드의 데이터 타입을 미리 지정하지 않고, 구체적인 타입은 사용하는 시점에 지정할 수 있도록 설계된 기능
...
class Pair<K, V> {
    ...
    // 제네릭 메서드
    // (접근지정자 static) <제네릭타입> 반환타입 메서드명(매개변수...) {}
    // : 메서드 호출 시 전달된 타입에 따라 T가 결정
    static <T> void print(T value) {
        System.out.println(value);
    }

    // <> 안에 들어가는 제네릭 타입 변수라고 함
...
public class A_Generic {
    public static void main(String[] args) {
        ...
        // 제네릭 타입 명시는 필수가 아님
        // 해당 제네릭 타입의 구조에 값이 들어올 경우 해당 값으로 타입을 유추
