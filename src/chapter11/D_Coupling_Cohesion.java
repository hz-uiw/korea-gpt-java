...
/*
    ...
    1. 결합도(낮은 결합도):
        ...
        - 낮은 결합도:
            프로그램을 유지 보수하기 쉽게 만들고 새로운 기능을 추가하거나 기존 코드를 수정할 때 오류 발생 가능성을 낮춘다.
    ...
    - 높은 응집도: 하나의 클래스가 관련된 일들만 하고, 해당 일이 잘 명시되어 있어야함
...
class User {
    // 2-2) 캡슐화: 필드를 private 설정, getter와 setter를 통해 접근, 클래스의 내부 동작을 숨기고, 외부와의 상호작용을 최소화
    private String name;
