...
/*
    ...
    cf) 기본데이터 타입: byte, short, int, long, float, double, boolean, char, void
    ...
    박싱(Boxing) & 언박싱(Unboxing):
        ...
        1) 박싱(Boxing):
            - 기본 데이터 타입 값을 해당하는 Wrapper 클래스의 객체로 변환하는 과정
        ...
        +) 박싱과 언박싱의 장단점:
            ...
            단점:
                - 객체를 생성하는 과정에서 추가적인 메모리 사용량이 증가되어 박싱, 언박싱 과정에서 성능저하
...
public class A_Wrapper {
    public static void main(String[] args) {
        ...
        // +) 문자열이 정수로 변환될 수 없는 경우 NumberFormatException이 발생
